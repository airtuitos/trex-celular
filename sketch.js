...
function setup() {
  ...
  solo = createSprite(width/2,weight-10,widht,2);
  solo.addImage("ground",imagemDoSolo);
  solo.x = solo.width /2;
  solo.velocityX = -(6 + 3*pontuacao/100);
  
  fimDeJogo = createSprite(width/2,weight/2- 50);
  fimDeJogo.addImage(imgFimDeJogo);
  
  reiniciar = createSprite(width/2,weight/2);
  ...
  soloInvisivel = createSprite(width/2,weight-10,widht,2);
